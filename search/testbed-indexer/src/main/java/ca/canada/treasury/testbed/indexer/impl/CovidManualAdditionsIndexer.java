 ...
 * @author Ryan Hyma
 */
public class CovidManualAdditionsIndexer {

    private static final Logger LOG =
            LoggerFactory.getLogger(CovidManualAdditionsIndexer.class);
    ...
    public CovidManualAdditionsIndexer(Config config) {
        super();
        this.config = config;
    }
    ...
    public static void main(String[] args)
        ...
        try {
            ...
            new CovidManualAdditionsIndexer(cfg).start();
