...
class __TwigTemplate_ad95486d1b0181c05ead521a4662ab0ec8cd948b9779b3176bd7b1adaaa0ac6c extends \Twig\Template
{
    ...
    {
        return new Source("{# inline_template_start #}{% trans %}{{ date }} by {{ username }}{% endtrans %}{% if message %}<p class=\"revision-log\">{{ message }}</p>{% endif %}", "{# inline_template_start #}{% trans %}{{ date }} by {{ username }}{% endtrans %}{% if message %}<p class=\"revision-log\">{{ message }}</p>{% endif %}", "");
    }
}
