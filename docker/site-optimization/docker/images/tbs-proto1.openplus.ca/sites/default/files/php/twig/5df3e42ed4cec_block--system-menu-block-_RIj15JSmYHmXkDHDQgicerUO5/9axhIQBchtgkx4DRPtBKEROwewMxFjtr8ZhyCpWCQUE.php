...
/* themes/contrib/wxt_bootstrap/templates/block/block--system-menu-block--account.html.twig */
class __TwigTemplate_497712dada161ce872c6ba8382865f58496edf2321f7d76c1b39d8430797cf12 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\"";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_without($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["attributes"] ?? null), "setAttribute", [0 => "id", 1 => "wb-sec"], "method"), "removeClass", [0 => "clearfix", 1 => "container"], "method")), "role", "aria-labelledby"), "html", null, true);
        echo ">
  ";
        // line 39
        echo "  ";
...
";
  ...
  ";
    ...
    {
        return "themes/contrib/wxt_bootstrap/templates/block/block--system-menu-block--account.html.twig";
    }
...
<nav role=\"navigation\" aria-labelledby=\"{{ heading_id }}\"{{ attributes.setAttribute('id', 'wb-sec').removeClass('clearfix', 'container')|without('role', 'aria-labelledby') }}>
...
", "themes/contrib/wxt_bootstrap/templates/block/block--system-menu-block--account.html.twig", "/var/www/html/tbs-proto1.openplus.ca/themes/contrib/wxt_bootstrap/templates/block/block--system-menu-block--account.html.twig");
    }
}
