...
/* themes/contrib/wxt_bootstrap/templates/views/views-mini-pager.html.twig */
class __TwigTemplate_3724dd378467657d8c0fe66da23484cac247f94b814d04a7a0c030250fb41b57 extends \Twig\Template
{
    ...
    <h4 class=\"sr-only\">";
            ...
            echo "</h4>
    <ul class=\"pager mini-pager js-pager__items\">
      ";
            // line 18
          ...
          <a href=\"";
            ...
            <span aria-hidden=\"true\">";
                // line 22
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (($this->getAttribute($this->getAttribute(($context["items"] ?? null), "previous", [], "any", false, true), "text", [], "any", true, true)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["items"] ?? null), "previous", [], "any", false, true), "text", [])), t("<span class=\"glyphicon glyphicon-chevron-left small\">"))) : (t("<span class=\"glyphicon glyphicon-chevron-left small\">"))), "html", null, true);
                echo "</span>
          </a>
        </li>
      ";
          ...
          <a href=\"";
            ...
            <span aria-hidden=\"true\">";
                // line 30
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (($this->getAttribute($this->getAttribute(($context["items"] ?? null), "next", [], "any", false, true), "text", [], "any", true, true)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["items"] ?? null), "next", [], "any", false, true), "text", [])), t("<span class=\"glyphicon glyphicon-chevron-right small\">"))) : (t("<span class=\"glyphicon glyphicon-chevron-right small\">"))), "html", null, true);
                echo "</span>
          </a>
        </li>
      ";
...
";
    ...
    {
        return "themes/contrib/wxt_bootstrap/templates/views/views-mini-pager.html.twig";
    }
      ...
      {% if items.previous %}
        <li class=\"previous\">
          <a href=\"{{ items.previous.href }}\" title=\"{{ 'Go to previous page'|t }}\" rel=\"prev\"{{ items.previous.attributes|without('href', 'title', 'rel') }}>
            ...
            <span aria-hidden=\"true\">{{ items.previous.text|default('<span class=\"glyphicon glyphicon-chevron-left small\">'|t) }}</span>
          </a>
        </li>
      {% endif %}
      {% if items.next %}
        <li class=\"next\">
          <a href=\"{{ items.next.href }}\" title=\"{{ 'Go to next page'|t }}\" rel=\"next\"{{ items.next.attributes|without('href', 'title', 'rel') }}>
            ...
            <span aria-hidden=\"true\">{{ items.next.text|default('<span class=\"glyphicon glyphicon-chevron-right small\">'|t) }}</span>
          </a>
        </li>
      {% endif %}
    </ul>
...
{% endif %}
", "themes/contrib/wxt_bootstrap/templates/views/views-mini-pager.html.twig", "/var/www/html/tbs-proto1.openplus.ca/themes/contrib/wxt_bootstrap/templates/views/views-mini-pager.html.twig");
    }
}
