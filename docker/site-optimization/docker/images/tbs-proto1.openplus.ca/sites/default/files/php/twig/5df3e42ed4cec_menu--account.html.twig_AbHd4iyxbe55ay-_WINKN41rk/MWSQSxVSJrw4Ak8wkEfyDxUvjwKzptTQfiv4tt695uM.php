...
/* themes/contrib/wxt_bootstrap/templates/menu/menu--account.html.twig */
class __TwigTemplate_c9044d098aaa903919a6a2fb7ce0cc5acf7b0a2ef70a9513493a9db074370190 extends \Twig\Template
{
...
";
    ...
    ";
                    ...
                    // line 32
                    echo "      <ul";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => "list-group", 1 => "menu", 2 => "list-unstyled"], "method")), "html", null, true);
                    echo ">
    ";
                }
                // line 34
...
$context["item"], "in_active_trail", [])) ? ("active") : (""))];
        ...
        <h3><a href=\"";
                        ...
                        echo " <span class=\"caret\"></span></a></h3>
      ";
                    } else {
                        // line 46
                        echo "        <li";
                        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($context["item"], "attributes", []), "addClass", [0 => "leaf"], "method")), "html", null, true);
                        echo ">
        ";
                        // line 47
  ...
  ";
    ...
    {
        return "themes/contrib/wxt_bootstrap/templates/menu/menu--account.html.twig";
    }
    ...
    {
        return array (  156 => 54,  149 => 52,  143 => 50,  140 => 49,  135 => 47,  130 => 46,  123 => 44,  118 => 43,  115 => 42,  113 => 39,  112 => 38,  111 => 37,  110 => 36,  108 => 35,  103 => 34,  97 => 32,  91 => 30,  88 => 29,  85 => 28,  82 => 27,  67 => 26,  60 => 24,  57 => 19,  55 => 18,);
    }
...
{% macro menu_links(items, attributes, menu_level, menu_name) %}
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      {% if menu_level == 0 and item.is_expanded %}
        ...
        <h3><a href=\"{{ item.url }}\" class=\"dropdown-toggle\" data-toggle=\"dropdown\">{{ item.title }} <span class=\"caret\"></span></a></h3>
      {% else %}
  ...
  {% endif %}
{% endmacro %}
", "themes/contrib/wxt_bootstrap/templates/menu/menu--account.html.twig", "/var/www/html/tbs-proto1.openplus.ca/themes/contrib/wxt_bootstrap/templates/menu/menu--account.html.twig");
    }
}
